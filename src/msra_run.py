    ...
    if args.checkpoint_path != "":
        ...
        # for name in os.listdir(args.checkpoint_path):
            ...
            # if os.path.isdir(full_name) and name.isdigit():
                # timesteps.append(int(name))
        # if not timesteps:
            # logger.console_logger.info("No checkpoints found.")
            # return

        # for timestep_to_load in sorted(timesteps): 
            # model_path = os.path.join(args.checkpoint_path, str(timestep_to_load))
            ...
            # except Exception as e:
                # logger.console_logger.error(f"Failed to load or evaluate model at timestep {timestep_to_load}: {e}")
        # logger.console_logger.info(f"test_battle_won_mean: {logger.test_battle_won_mean}")
        # runner.close_env()
        # logger.console_logger.info("Finished testing all checkpoints.") 
        # return
